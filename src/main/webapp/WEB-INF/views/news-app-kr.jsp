...
<body>
	<!-- news content -->
	<div class="news" style="max-width:100%;padding:0px">
		<div class="news-contents">
			<!-- news-content -->
			<div class="news-content" style="padding:0px">
				<div class="news-suject">
					<a href="#"><strong>[Notice]</strong>고객 센터 안내<span class="news-time">2018.02.02</span></a>
				...
				<div class="news-suject">
					<a href="#"><strong>[Notice]</strong>한패스 오픈 및 송금 라이센스 취득 공지<span class="news-time">2018.02.02</span></a>
					<div class="news-toggle">
						<p class="news-text">
				...
				<div class="news-suject">
					<a href="#"><strong>[Notice]</strong>페이스북 이벤트 안내<span class="news-time">2018.02.02</span></a>
					<div class="news-toggle">
