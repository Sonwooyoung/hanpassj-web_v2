				...
				<div class="intro-content">
					<header>
						<div class="header-inner">
							...
							<ul class="util ns-en">
								<li>
									<a href="#"><span class="lang ko"></span>KOR <span class="ion-android-arrow-dropdown"></span></a>
									<ul>
					...
					<ul class="text-large-wrap">
						<li><h2 class="font-color-white">우리는, 한패스입니다.</h2></li>
						<li><h2>한패스는 기준입니다.</h2></li>
						<li><h2>한패스를 소개합니다.</h2></li>
						<li><h2 class="font-color-white">한패스를 만나보세요.</h2></li>
					</ul>
					<ul class="text-small-wrap">
						<li class="font-color-white">한패스는 국내 핀테크 시장을 선도하는 기업으로,<br>여러분의 더 나은 내일을 위해 언제나 노력합니다.</li>
						<li>당신은 최소한의 터치로,<br>지금까지 만날 수 없었던 쉽고 빠르고 저렴한 해외송금서비스를 만날 수 있습니다.</li>
						<li>소액해외 송금업 라이센스를 취득으로,<br>한패스는 고객들에게 언제 어디서나 신뢰할 수 있는 해외송금 서비스을 제공하는 역할을 합니다. </li>
						<li class="font-color-white">한패스는 고객들에게 최상의 환율을 제공하여,<br>송금 수수료 최대 90%까지로 해외송금이 가능합니다.</li>
					</ul>
					<ul class="more-btn ns-en">
						<li><a href="/kr/company">LEARN MORE</a></li>
						<li><a href="/kr/product">LEARN MORE</a></li>
						<li><a href="/kr/company">LEARN MORE</a></li>
						<li><a href="/kr/product">LEARN MORE</a></li>
					</ul>
				</div><!--// content -->
